...
def TRepNet(n_steps, n_features, activation='elu'):
    ...
    w = (n_steps * n_features) / codings_size
    ...
    z2 = Dense(codings_size, kernel_initializer='lecun_normal',  activation='selu')(resnet)
    ...
    dconv = keras.layers.Reshape([codings_size, 1, 1])(decoder_input)
