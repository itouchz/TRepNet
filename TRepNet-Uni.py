...
selected_uni_datasets = ['UMD', 'Earthquakes', 'ArrowHead', 'BeetleFly', 'ChlorineConcentration', 'Chinatown', 'DiatomSizeReduction', 'ECG200', 'ECG5000', 'ECGFiveDays',
                         ...
                         'SyntheticControl', 'Trace', 'UWaveGestureLibraryAll', 'Wafer', 'Yoga']
